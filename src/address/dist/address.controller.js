...
var AddressController = /** @class */ (function () {
    ...
    AddressController.prototype.create = function (createProductDto, res) {
        return __awaiter(this, void 0, void 0, function () {
            var newAddress, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.addressService.create(createProductDto)];
                    case 1:
                        newAddress = _a.sent();
    ...
    AddressController.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.addressService.getAll()];
            });
        });
    };
    __decorate([
        common_1.Post(),
        swagger_1.ApiCreatedResponse({ type: address_entity_1.Address }),
    ...
    __decorate([
        common_1.Get()
    ], AddressController.prototype, "getAll");
