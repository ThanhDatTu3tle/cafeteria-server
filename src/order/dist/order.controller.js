...
var OrderController = /** @class */ (function () {
    ...
    OrderController.prototype.create = function (createOrderDto, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.orderService.create(createOrderDto)];
                    case 1:
                        newOrder = _a.sent();
    ...
    __decorate([
        common_1.Post(),
        swagger_1.ApiCreatedResponse({ type: order_entity_1.Order }),
